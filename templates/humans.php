...
function uncheck_radio(c) {
  ...
  <div class="container-fluid">
	...
	<center>
<p>Рекомендовано прохождение за людей (мятежников) - Сторона Инноса.</p>
</center>
...
<caption> <strong><font color="white">Если Вы желаете получить дополнительные советы, заполните следующую форму и я свяжусь с Вами </font></strong></caption>
  <p class="int_h">
<th align="center">  <font align="left" color="white"><p><b>Как к Вам обращаться?</b></p></font>
...
{	switch( $_POST['a001'] )
	{
        case 'First':
			echo'<p class="int_h">';
			echo' <tr><th align="center"> <font align="left" ><p><b>Варианты выбранной расы:</b></p></font>';
			echo'<td colspan="3" align="center">   <p><select size="3" multiple name="hero[]">';
			echo'<option disabled><font align="left" color="black">Выберите героя</font></option>';
			echo'<option value="1"><font align="left" style="color:black;">Мятежник</font></option>';
			echo'<option value="2"><font align="left" color="black">Наёмник</font></option>';
			echo'<option value="3"><font align="left" color="black">Маг</font></option>';
			echo'</select></p>';
			echo'</p>';
		break;
	...
	if($uphone!=0)
		{
			echo'<tr><th align="center"> <font align="left" color="white">Типы</font>';
			echo'<td colspan="3" align="center">';
	for($i=1;$i<=$uphone;$i++)
	{
		echo '<input type="checkbox" name="b001"><font color="white"> Тип ' . $i . '</font>';
	}
		}
?>
